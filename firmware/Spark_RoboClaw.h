#ifndef Spark_RoboClaw_h
#define Spark_RoboClaw_h
...
public:
	// public methods
	RoboClaw(uint8_t baud, uint8_t tout);	
	...
	bool ReadCurrents(uint8_t address, uint16_t &current1, uint16_t &current2);
